...
(* OASIS_START *)
(* DO NOT EDIT (digest: ea895ba2a781e5cdd38b425992830b73) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "wsproxy.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xapi-project/wsproxy";
                      src_repo_browser =
                        Some "https://github.com/xapi-project/wsproxy";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\022F\1828\006b\215\234\218\236\012\147\2269\015R";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
